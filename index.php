...
<html lang="en">
<head>
  <title>Welcome to Online Larki Dhondo</title>
  <meta charset="utf-8">
...
<body style=" height: 50px; background-size: cover; ">
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
    <a class="navbar-brand" href="#">Larki Dhondo.com</a>
    <div class="">
    <ul style="padding-left: 600px;" class="navbar-nav ml-auto ">
       <li  class="nav-item active Center">
        <li style="" class="nav-item active">
             </li>
      <li  class="nav-item active Center">
        <li style="" class="nav-item active">
        <button style="padding-left:50px; color: white; background-color: red; margin-left: 500px;" type="button" class="btn btn mx-2" onclick="addForm()">+ Add</button>
      </li>
     </li><br>
    ...
    <div class="container"><br>
      <div class="row " style="background-color: rgba(245, 245, 245, 1); opacity: .8">
        <div class="col-md-12">
...
mysqli_close($link);
    ...
    echo "<table class='container' style='background-color: rgba(245, 245, 245, 1)' opacity: .8>
    <tr>
    <th>Id</th>
    <th>Name</th>
    <th>Email</th>
